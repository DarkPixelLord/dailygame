// Frozen legacy translations (v1 guide). See docs/event-writing-guide-v1.md.
// Not served by the game anymore; kept for reference. New content goes in poc-events-fr.ts.
import type { EventTranslation } from "./poc-events-fr";

export const LEGACY_EVENTS_FR: Record<string, EventTranslation> = {
  hastings: {
