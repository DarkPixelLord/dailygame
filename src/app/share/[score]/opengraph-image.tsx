...
export const alt = "History Guess — Final Score";
export const size = { width: 1200, height: 630 };
export const contentType = "image/png";

// Same laurel wreath as LaurelIcon.tsx, inlined: ImageResponse (satori)
// renders raw SVG markup fine, but can't import a React component that
// isn't itself expressed as plain JSX/SVG at build time here.
const LAUREL_PATH =
...
export default async function Image({ params }: { params: Promise<{ score: string }> }) {
  ...
  return new ImageResponse(
    (
      ...
      >
        <svg viewBox="0 0 512 512" width="130" height="130" fill="#fbbf24" style={{ display: "flex" }}>
          <path d={LAUREL_PATH} />
        </svg>
