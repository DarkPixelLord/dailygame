...
// From public/icons/locked-fortress-svgrepo-com.svg, inlined so its fill can
// follow `currentColor` instead of a hardcoded black.
export default function FortressIcon({ className }: Props) {
  return (
