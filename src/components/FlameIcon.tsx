...
// Heroicons v2 solid "fire" icon, inlined so its fill follows `currentColor`
// like the rest of this repo's icon set.
export default function FlameIcon({ className }: Props) {
  return (
